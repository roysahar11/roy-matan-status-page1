...
DATABASE = {
    'NAME': os.environ.get('POSTGRES_DB_NAME', 'status-page'),         # Database name
    ...
    'PORT': os.environ.get('POSTGRES_PORT', ''),               # Database port (leave blank for default)
    'CONN_MAX_AGE': os.environ.get('POSTGRES_CONN_MAX_AGE', 300),      # Max database connection age
}
...
REDIS = {
    'tasks': {
        'HOST': os.environ.get('REDIS_HOST', 'localhost.localstack.cloud'),
        ...
        'INSECURE_SKIP_TLS_VERIFY': os.environ.get('REDIS_SKIP_TLS_VERIFY', 'False').lower() == 'true',
    },
    'caching': {
        'HOST': os.environ.get('REDIS_HOST', 'localhost.localstack.cloud'),
        'PORT': os.environ.get('REDIS_PORT', 6379),
...
ADMINS = [
    (os.environ.get('ADMIN_NAME', ''), os.environ.get('ADMIN_EMAIL', 'example@example.com'))
]
